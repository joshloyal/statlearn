...
class LinDA:
    ...
    def fit(self, Xtrain, Ytrain):
        ...
        # sphere the training data and calculate the position of the centroids
...
if __name__ == '__main__':
    ...
    scikit_lda(X, y)
    lda, y_pred = linear_discriminant_analysis(X,y)
    splot = plot_lda(lda, X, y, y_pred, 1)
    plt.show()
